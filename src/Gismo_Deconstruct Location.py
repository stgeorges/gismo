...
Provided by Gismo 0.0.1
    ...
    input:
        _location: And .epw file location: joined string containing information about location's components: locationName, latitude, longitude, timeZone and elevation.
